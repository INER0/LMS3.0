...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-)gulj(_#w9n0-cylk8awk7mvhha=)db56#lf@kv*shm)-pvlu2')
...
# Password Settings
PASSWORD_EXPIRY_DAYS = 180  # 6 months for admin/manager
